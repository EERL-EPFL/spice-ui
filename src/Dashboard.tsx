        ...
        <Box sx={{ p: 2 }}>
            ...
            <Paper sx={{ p: 2, mb: 4 }}>
                ...
                {isLoading ? (
                                    ...
                                    secondary={
                                        <Box>
                                            <Typography variant="body2">
                                                Last updated: {new Date(experiment.updated_at || experiment.performed_at).toLocaleString()}
                                            </Typography>
                    ...
                    <Alert severity="info">
                        No experiments found. Create your first experiment using the button above.
                    </Alert>
                )}
            </Paper>
